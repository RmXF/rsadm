...
local bot_retorno="$LINE\n"
          ...
          bot_retorno+="/ADMIN usuario contraseña \n"
          bot_retorno+="$LINE\n"
...
local bot_retorno+="$LINE\n"
          ...
          bot_retorno+="$LINE\n"
          bot_retorno+="✅ Usted ya Puede usar el Bot\n"
...
error_fun () {
local bot_retorno="*$LINE*\n"
          bot_retorno+="*❌ USUARIO NO REGISTRADO  ❌*\n"
          bot_retorno+="*$LINE*\n"
	      ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
							--text "$(echo -e $bot_retorno)" \
							--parse_mode markdown
